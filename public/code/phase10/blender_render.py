"""Phase 10 — Blender Cycles renderer for 3D MPM flood.

Imports reconstructed OBJ building (Z-up) + water mesh OBJ sequence.
Photorealistic flood water with mirror reflections, procedural sky dome.

Usage:
    blender --background --python blender_render.py -- \
        --meshes ./export/flood/meshes --building ~/Downloads/models/0_1_cluster_texture.obj \
        --meta ./export/flood/meta.json --output ./renders
"""
import bpy
import math
import os
...
p.add_argument("--building", default=None, help="Path to building OBJ (overrides meta)")
...
def import_building(meta):
    """Import building OBJ (Z-up) at native coordinates."""
    if args.building:
    ...
    print(f"  Building: {len(meshes)} meshes (native Z-up coords)")
...
def render_frames():
    ...
    print("=" * 60)
    print("Phase 10 — Photorealistic Flood Renderer")
